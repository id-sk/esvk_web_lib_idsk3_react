  ...
  return (
    <div className="bg-neutral-200" {...props}>
      ...
      <main className="pt-[7.75rem] pb-16 tb1:pt-48 min-h-screen">
        <div className="realtive inset-x-0 mx-auto px-5 pb-6 tb1:pb-7 tb1:px-8 dm1:px-5 dl:px-4 max-w-6xl dl:max-w-[96rem]">
          {titleSection}
        </div>
        <div className="realtive inset-x-0 mx-auto tb1:px-8 dm1:px-5 dl:px-4 max-w-6xl dl:max-w-[96rem]">
          {children}
        </div>
      </main>
    </div>
