...
const SvgCheckImg = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 99 90" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      ...
      fill="url(#check_img_svg__a)"
    />
    <g opacity={0.5} filter="url(#check_img_svg__b)">
      <path
    ...
    <path
      ...
      fill="url(#check_img_svg__c)"
      mask="url(#check_img_svg__d)"
    />
    <g filter="url(#check_img_svg__e)">
      <mask id="check_img_svg__h" fill="#fff">
      ...
      <path
        ...
        fill="url(#check_img_svg__g)"
        fillOpacity={0.5}
        mask="url(#check_img_svg__h)"
      />
    </g>
    <defs>
      <linearGradient
